...
One paradise in this chapter has an address you can fly to. The rest of the texts make claims that can still be checked — that death was not original equipment but arrived at a specific moment, that paradise sat between named rivers, that farming and cities began right there. Creation argued that the world was made without death in it. This is the chapter where death gets in. Here's where the data lands — including one place where it does not land where this book would like it to.

**What the mitochondrial and Y lineages do and do not show**  
Observation: Two lineages can be traced without recombination: mitochondrial DNA, passed only from mother to child, and the non-recombining Y chromosome, passed only from father to son. Follow either back far enough and it converges on a single individual — the matrilineal and patrilineal most recent common ancestors, nicknamed Mitochondrial Eve and Y-chromosomal Adam. Poznik et al. sequenced the Y properly in 2013 and dated them: the male ancestor at 120,000–156,000 years, the female at 99,000–148,000. The windows overlap across 28,000 years.  
