...
**Every line runs back to one woman and one man — and they overlap**  
Observation: Two separate lineages can be traced without recombination: mitochondrial DNA, which passes only from mother to child, and the non-recombining Y chromosome, which passes only from father to son. Follow either back and it converges. Every living woman's maternal line meets in one woman; every living man's paternal line meets in one man. That much was never in dispute. What was in dispute was WHEN — and for years the answer was used against the text, because the two dates appeared to be tens of thousands of years apart. Poznik et al. sequenced the Y chromosome properly in 2013 and the gap closed: the male common ancestor at 120,000–156,000 years, the female at 99,000–148,000. The ranges overlap across 28,000 years.  
What it points to: The text says humanity began with one pair. The genetics gives a single convergence point on each line, and — since 2013 — two windows that sit on top of one another instead of far apart. The objection that they could not have been contemporaries was the strongest thing anyone had against reading this data alongside Genesis, and it was removed by better sequencing, not by argument.  
Notes: Two findings, and they are doing different jobs. POZNIK 2013 is about the convergence date. Before it, the mismatch between the mitochondrial and Y-chromosome estimates was the standard reason given for why this data could not be read the way the text reads: they were not contemporaries, so there was no pair. Sequencing the whole Y rather than genotyping a handful of markers moved the male estimate to 120–156 thousand years and the female to 99–148, and the windows now overlap. KARMIN 2015 is about something else entirely — a SECOND event, much later. Sequencing 456 Y chromosomes from 110 populations at 35,700 sites, the authors report 'a second strong bottleneck in Y-chromosome lineages dating to the last 10 ky.' A crash in male lineage diversity, worldwide, within the last ten thousand years, long after any out-of-Africa event. Their proposed cause is cultural — a change in how many men were fathering children. What the finding itself establishes, independent of the cause proposed for it, is that the male line of the human race passed through a severe narrowing well inside the window the genealogies of Genesis 5 and 11 describe. The Great Flood and The Tower carry what the text says happened in that window.  
